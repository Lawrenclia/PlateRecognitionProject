...
## AI写的废话
好的，没问题。我们用一个更平常的口吻来讲讲你们小组（4-5人）怎么在 GitHub 上合作。

这套方法主要是为了防止出现“我代码怎么被覆盖了！”或者“项目怎么跑不起来了！”这类灾难，保证你们能顺利合作。

我们将使用一个叫 **GitHub Flow** 的工作流，它非常简单，很适合你们的课程项目。
...
当你要开始做一个新功能时（比如“开发GUI界面”），请严格按以下步骤操作：
...
这套流程刚开始可能感觉有点繁琐，但只要习惯了，它就能帮你们（4-5个人）清晰地分工，并且保证 `main` 分支永远是可用的，是你们的“最终成果”。

为了方便大家遵守，你们可以把这些规则写在一个叫 `CONTRIBUTING.md` 的文件里放到项目根目录。

需要我帮你们根据项目要求，列一个任务清单（Issues），方便你们开始分工吗？
